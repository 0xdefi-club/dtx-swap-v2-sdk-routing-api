...
var e = require('@uniswap/sdk-core'),
  ...
  u = require('@ethersproject/bignumber'),
  o = require('@ethersproject/solidity'),
  i = t(require('tiny-invariant')),
  s = e.V2_FACTORY_ADDRESSES,
  a = '0x8615843ab28b4b86b2382dca22cf14f0a6ba9e52cb006531eb574042a5b54a46',
  c = r.BigInt(1e3),
  p = r.BigInt(0),
  l = r.BigInt(1),
  m = r.BigInt(5),
...
function I(t) {
  ...
  return (I = function(t) {
    ...
    function r() {
      return b(t, arguments, k(this).constructor)
    }
    return (
...
var E = 'setPrototypeOf' in Object,
  _ = (function(t) {
    function e() {
      ...
      return (
        ...
        E && Object.setPrototypeOf(O(r), (this instanceof e ? this.constructor : void 0).prototype),
        r
      )
    }
    return q(e, t), e
  ...
  F = function(t) {
    var e = t.factoryAddress,
      r = t.tokenA,
      u = t.tokenB,
      i = r.sortsBefore(u) ? [r, u] : [u, r]
    return n.getCreate2Address(
      e,
      o.keccak256(['bytes'], [o.pack(['address', 'address'], [i[0].address, i[1].address])]),
      a
    )
  },
  R = (function() {
    function t(r, n) {
      var u = r.currency.sortsBefore(n.currency) ? [r, n] : [n, r]
      ;(this.liquidityToken = new e.Token(
        u[0].currency.chainId,
        t.getAddress(u[0].currency, u[1].currency),
        18,
        'DTXSwap-V1',
        'DTXSwap-V1'
      )),
    ...
    t.getAddress = function(t, e) {
      var r,
        n = null != (r = s[t.chainId]) ? r : '0x2EA9051d5a48eA2350b26306f2b959D262cf67e1'
      return F({ factoryAddress: n, tokenA: t, tokenB: e })
    }
    var n = t.prototype
    return (
      ...
      (n.getOutputAmount = function(n, u) {
        if (
          (void 0 === u && (u = !0),
          ...
          throw new _()
        var o = this.reserveOf(n.currency),
          s = this.reserveOf(n.currency.equals(this.token0) ? this.token1 : this.token0),
          a = u ? this.derivePercentAfterSellFees(n) : y,
          ...
          f = r.add(r.multiply(o.quotient, d), l),
          v = e.CurrencyAmount.fromRawAmount(n.currency.equals(this.token0) ? this.token1 : this.token0, r.divide(m, f))
        if (r.equal(v.quotient, p)) throw new C()
        var A = u ? this.derivePercentAfterBuyFees(v) : y,
          T = A.greaterThan(y) ? e.CurrencyAmount.fromRawAmount(v.currency, v.multiply(A).quotient) : v
        if (r.equal(T.quotient, p)) throw new C()
        return [T, new t(o.add(c), s.subtract(T))]
      }),
      (n.getInputAmount = function(n, u) {
        void 0 === u && (u = !0), this.involvesToken(n.currency) || i(!1)
        var o = u ? this.derivePercentAfterBuyFees(n) : y,
          s = o.greaterThan(y) ? e.CurrencyAmount.fromRawAmount(n.currency, r.add(n.divide(o).quotient, l)) : n
        if (
      ...
      (n.getLiquidityMinted = function(t, n, u) {
        ...
        if (((s[0].currency.equals(this.token0) && s[1].currency.equals(this.token1)) || i(!1), r.equal(t.quotient, p)))
          ...
          o = r.lessThanOrEqual(a, l) ? a : l
        }
        if (!r.greaterThan(o, p)) throw new C()
        return e.CurrencyAmount.fromRawAmount(this.liquidityToken, o)
      }),
      (n.getLiquidityValue = function(t, n, u, o, s) {
        var a
        if (
          (void 0 === o && (o = !1),
          this.involvesToken(t) || i(!1),
          n.currency.equals(this.liquidityToken) || i(!1),
          u.currency.equals(this.liquidityToken) || i(!1),
          r.lessThanOrEqual(u.quotient, n.quotient) || i(!1),
          o)
        ) {
          s || i(!1)
          var c = r.BigInt(s)
        ...
        return e.CurrencyAmount.fromRawAmount(
          t,
          r.divide(r.multiply(u.quotient, this.reserveOf(t).quotient), a.quotient)
        )
      }),
      (n.derivePercentAfterSellFees = function(t) {
        ...
        return null != n && n.gt(u.BigNumber.from(0)) ? v.subtract(new e.Percent(r.BigInt(n)).divide(f)) : y
      }),
  ...
  S = (function() {
    function t(t, e, r) {
      ...
      var u = e.wrapped
      t[0].involvesToken(u) || i(!1), void 0 === r || t[t.length - 1].involvesToken(r.wrapped) || i(!1)
      for (var o, s = [u], a = P(t.entries()); !(o = a()).done; ) {
        var c = o.value,
          p = c[1],
          l = s[c[0]]
          ...
          get: function() {
            ...
            for (var t, r = [], n = P(this.pairs.entries()); !(t = n()).done; ) {
              var u = t.value,
                o = u[1]
              r.push(
                this.path[u[0]].equals(o.token0)
                  ? new e.Price(o.reserve0.currency, o.reserve1.currency, o.reserve0.quotient, o.reserve1.quotient)
                  : new e.Price(o.reserve1.currency, o.reserve0.currency, o.reserve1.quotient, o.reserve0.quotient)
              )
            }
...
var N = (function() {
  function t(t, r, n) {
    ...
    if (n === e.TradeType.EXACT_INPUT) {
      r.currency.equals(t.input) || i(!1), (u[0] = r.wrapped)
      for (var o = 0; o < t.path.length - 1; o++) {
        var s = t.pairs[o].getOutputAmount(u[o])
        u[o + 1] = s[0]
      }
      ...
      r.currency.equals(t.output) || i(!1), (u[u.length - 1] = r.wrapped)
      for (var a = t.path.length - 1; a > 0; a--) {
        var c = t.pairs[a - 1].getInputAmount(u[a])
        u[a - 1] = c[0]
      }
      ;(this.inputAmount = e.CurrencyAmount.fromFractionalAmount(t.input, u[0].numerator, u[0].denominator)),
  ...
  return (
    ...
    (t.bestTradeExactIn = function(r, n, u, o, s, a, c) {
      var l = void 0 === o ? {} : o,
        m = l.maxNumResults,
        h = void 0 === m ? 3 : m,
        d = l.maxHops,
      ...
      void 0 === s && (s = []),
        ...
        f > 0 || i(!1),
        n === a || s.length > 0 || i(!1)
      for (var y = a.wrapped, v = u.wrapped, A = 0; A < r.length; A++) {
        var T = r[A]
        if (
          ...
          if (q.currency.equals(v))
            e.sortedInsert(c, new t(new S([].concat(s, [T]), n.currency, u), n, e.TradeType.EXACT_INPUT), h, j)
          else if (f > 1 && r.length > 1) {
            var k = r.slice(0, A).concat(r.slice(A + 1, r.length))
            t.bestTradeExactIn(k, n, u, { maxNumResults: h, maxHops: f - 1 }, [].concat(s, [T]), q, c)
          }
        }
      }
      return c
    ...
    (t.bestTradeExactOut = function(r, n, u, o, s, a, c) {
      var l = void 0 === o ? {} : o,
        m = l.maxNumResults,
        h = void 0 === m ? 3 : m,
        d = l.maxHops,
      ...
      for (var y = a.wrapped, v = n.wrapped, A = 0; A < r.length; A++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            e.sortedInsert(c, new t(new S([T].concat(s), n, u.currency), u, e.TradeType.EXACT_OUTPUT), h, j)
          else if (f > 1 && r.length > 1) {
            var k = r.slice(0, A).concat(r.slice(A + 1, r.length))
            t.bestTradeExactOut(k, n, u, { maxNumResults: h, maxHops: f - 1 }, [T].concat(s), q, c)
          }
        }
      }
      return c
...
var D = (function() {
  ...
  return (
    (t.swapCallParameters = function(t, r) {
      ...
      n && u && i(!1), !('ttl' in r) || r.ttl > 0 || i(!1)
      var o,
        s,
        a,
        c = e.validateAndParseAddress(r.recipient),
        p = U(t.maximumAmountIn(r.allowedSlippage)),
        l = U(t.minimumAmountOut(r.allowedSlippage)),
      ...
      switch (t.tradeType) {
        ...
        case e.TradeType.EXACT_OUTPUT:
          d && i(!1),
            n
              ? ((o = 'swapETHForExactTokens'), (s = [l, m, c, h]), (a = p))
              : u
              ? ((o = 'swapTokensForExactETH'), (s = [l, p, m, c, h]), (a = '0x0'))
              : ((o = 'swapTokensForExactTokens'), (s = [l, p, m, c, h]), (a = '0x0'))
      }
