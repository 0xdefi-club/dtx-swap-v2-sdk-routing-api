...
var E = 'setPrototypeOf' in Object,
  ...
  R = (function() {
    ...
    t.getAddress = function(t, e) {
      var r,
        n = null != (r = s[t.chainId]) ? r : '0x61b781d983f5D2134946dF130E9B62962C71b2C0'
    ...
    return (
      ...
      (n.getOutputAmount = function(n, u) {
        ...
        if (r.equal(v.quotient, p)) throw new _()
      ...
      (n.getLiquidityMinted = function(t, n, u) {
        ...
        if (!r.greaterThan(o, p)) throw new _()
      ...
      for (var y = a.wrapped, v = u.wrapped, A = 0; A < r.length; A++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            e.sortedInsert(c, new t(new B([].concat(s, [T]), n.currency, u), n, e.TradeType.EXACT_INPUT), h, j)
    ...
    (t.bestTradeExactOut = function(r, n, u, o, s, a, c) {
      ...
      for (var y = a.wrapped, v = n.wrapped, A = 0; A < r.length; A++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            e.sortedInsert(c, new t(new B([T].concat(s), n, u.currency), u, e.TradeType.EXACT_OUTPUT), h, j)
          else if (f > 1 && r.length > 1) {
            var k = r.slice(0, A).concat(r.slice(A + 1, r.length))
...
;(exports.FACTORY_ADDRESS_MAP = s),
  ...
  (exports.InsufficientReservesError = C),
  ...
  (exports.inputOutputComparator = S),
